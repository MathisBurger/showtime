...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETDMX']._serialized_end=536
  _globals['_SETDMX_OUTPUTDATA']._serialized_start=487
  _globals['_SETDMX_OUTPUTDATA']._serialized_end=536
